...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.043137,0.043137,0.043137,0.000000);//Base Color
	Material.VectorExpressions[3] = float4(0.043137,0.043137,0.043137,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.300000,0.200000,0.000000);//(Unknown) Specular Roughness (Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Specular = Material.ScalarExpressions[0].y;
	PixelMaterialInputs.Roughness = Material.ScalarExpressions[0].z;
