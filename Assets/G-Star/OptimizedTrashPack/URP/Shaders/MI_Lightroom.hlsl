...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.000000,0.000000,0.000000,1.000000);//Emissive
	...
	Material.VectorExpressions[4] = float4(0.347655,0.368281,0.375000,0.000000);//Tint
	Material.VectorExpressions[5] = float4(0.347655,0.368281,0.375000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = lerp(Material.VectorExpressions[2].rgb,Material.VectorExpressions[3].rgb,MaterialFloat(Material.ScalarExpressions[0].x));
	MaterialFloat Local1 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 0);
	MaterialFloat4 Local2 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0, samplerMaterial_Texture2D_0,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local3 = MaterialStoreTexSample(Parameters, Local2, 0);
	MaterialFloat3 Local4 = (Local2.rgb * Material.VectorExpressions[5].rgb);
